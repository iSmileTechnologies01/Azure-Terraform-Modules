...
variable "subnet_prefixes" {
  ...
  type        = list(string)
  default     = ["10.1.0.0/19", "10.1.32.0/19", "10.1.64.0/18", "10.1.128.0/17"]
}
//VNET 2  address prefix
variable "subnet_prefixes1" {
  description = "The address prefix to use for the subnet."
  type        = list(string)
  default     =["10.2.0.0/18", "10.2.64.0/19", "10.2.96.0/20" ,"10.2.112.0/22", "10.2.120.0/21", "10.2.128.0/18","10.2.116.0/22"]
}

variable "subnet_names" {
  description = "A list of public subnets inside the vNet."
  type        = list(string)
  default     = ["Gateway", "FW-MGMT", "FW-Trust","FW-untrust"]
}
// vnet 2 subnet 
...
variable "subnet_names1" {
  description = "A list of public subnets inside the vNet."
  type        = list(string)
  default     = ["Core_Services", "Remote_Access","Private_Endpoint", "NGFW_Mgmt","AD_Subnet","SIEM","APIM_subnet"]
}
